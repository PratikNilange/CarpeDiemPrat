        ...
        33: [function(t, Xt, Jt) {
            (function(t) {
                var d = "function" == typeof Symbol && "symbol" == _typeof(Symbol.iterator) ? function(t) {
                    ...
                    f = /^(?:0|[1-9]\d*)$/,
                    Q = {};
                Q[k] = Q["[object Array]"] = Q[I] = Q[O] = Q[x] = Q[_] = Q[F] = Q[R] = Q[H] = Q[N] = Q[W] = Q[M] = Q[A] = Q[B] = Q[z] = Q[D] = Q[q] = Q[T] = Q[U] = Q[V] = Q[G] = Q[X] = !0, Q["[object Error]"] = Q[P] = Q[s] = !1;
                ...
                var m, v = Array.prototype,
                    g = Function.prototype,
                    y = Object.prototype,
                    b = a["__core-js_shared__"],
                    L = (m = /[^.]+$/.exec(b && b.keys && b.keys.IE_PROTO || "")) ? "Symbol(src)_1." + m : "",
                    S = g.toString,
                    it = y.hasOwnProperty,
                    E = y.toString,
                    w = RegExp("^" + S.call(it).replace(/[\\^$.*+?()[\]{}|]/g, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"),
                    C = u ? a.Buffer : void 0,
                    nt = a.Symbol,
                    ot = a.Uint8Array,
                ...
                function At(r, a, l, c, t, e, u) {
                    ...
                    if (g) {
                        if (m = (p = r).length, v = p.constructor(m), m && "string" == typeof p[0] && it.call(p, "index") && (v.index = p.index, v.input = p.input), d = v, !a) return function(t, e) {
                            var i = -1,
                                n = t.length;
                        ...
                        if (y == B || y == k || b && !e) {
                            if (K(r)) return e ? r : {};
                            if (d = "function" != typeof(h = b ? {} : r).constructor || Ot(h) ? {} : Vt(f = st(h)) ? rt(f) : {}, !a) return s = i = r, n = (o = d) && zt(s, Gt(s), o), zt(i, Tt(i), n)
                        } else {
                            if (!Q[y]) return e ? r : {};
                            d = function(t, e, i, n) {
                                ...
                                switch (e) {
                                    ...
                                    case _:
                                        return new f(+t);
                                    case O:
                                        return d = t, h = n ? Bt(d.buffer) : d.buffer, new d.constructor(h, d.byteOffset, d.byteLength);
                                    case F:
                                    case R:
                                    case H:
                                    case N:
                                    ...
                                    case G:
                                    case X:
                                        return c = t, u = n ? Bt(c.buffer) : c.buffer, new c.constructor(u, c.byteOffset, c.length);
                                    case M:
                                        return l = t, Z(n ? i(tt(l), !0) : tt(l), Y, new l.constructor);
                                    case A:
                                    case q:
                                        return new f(t);
                                    case z:
                                        return (a = new(r = t).constructor(r.source, J.exec(r))).lastIndex = r.lastIndex, a;
                                    case D:
                                        return s = t, Z(n ? i(et(s), !0) : et(s), $, new s.constructor);
                                    case T:
                    ...
                    var L, S, E, w = u.get(r);
                    if (w) return w;
                    if (u.set(r, d), !g) var C = l ? (S = Tt, E = Gt(L = r), Ht(L) ? E : function(t, e) {
                        for (var i = -1, n = e.length, o = t.length; ++i < n;) t[o + i] = e[i];
                        return t
                    }(E, S(L))) : Gt(r);
                    return function(t, e) {
                        for (var i = -1, n = t ? t.length : 0; ++i < n && !1 !== (o = t[i], s = i, C && (o = r[s = o]), void jt(d, s, At(o, a, l, c, s, r, u))););
                        var o, s
                    }(C || r), d
                }
                ...
                kt.prototype.clear = function() {
                    ...
                    var e = this.__data__,
                        i = Mt(e, t);
                    return !(i < 0 || (i == e.length - 1 ? e.pop() : lt.call(e, i, 1), 0))
                ...
                function Gt(t) {
                    return Nt(t) ? function(t, e) {
                        var i, n, o, s, r, a = Ht(t) || (o = n = i = t) && "object" == (void 0 === o ? "undefined" : d(o)) && Nt(n) && it.call(i, "callee") && (!at.call(i, "callee") || E.call(i) == k) ? function(t, e) {
                            ...
                            l = a.length,
                            c = !!l;
                        for (var u in t) !e && !it.call(t, u) || c && ("length" == u || (s = u, (r = null == (r = l) ? h : r) && ("number" == typeof s || f.test(s)) && -1 < s && s % 1 == 0 && s < r)) || a.push(u);
                        return a
                    }(t) : function(t) {
                        if (!Ot(t)) return dt(t);
                        var e = [];
            ...
            var a, l, c = [],
                ...
                p = function(t, e) {
                    var i = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : d(),
                        ...
                        r = t.match(/[a-z]+$/)[0],
                        a = 0;
                    return "top" === r && (a -= 0), "middle" === r && (a -= n / 2), "bottom" === r && (a -= n), "top" === s && (a += o.top + i), "middle" === s && (a += o.top + i + o.height / 2), "bottom" === s && (a += o.top + i + o.height), a + "px"
                },
                m = function(t) {
                    var e, i, n = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : d(),
                        l = t.getData(),
                        ...
                        n = {
                            ...
                            calculate: function() {
                                e = function() {
                                    ...
                                    if (null == (i = (0, s.default)(i)).from) throw new Error("Missing property `from`");
                                    if (null == i.to) throw new Error("Missing property `to`");
                                    if (null == i.inside && (i.inside = function() {}), null == i.outside && (i.outside = function() {}), !0 === i.direct && null == i.elem) throw new Error("Property `elem` required when `direct` is true");
                                    if (!0 !== i.direct && i.direct instanceof HTMLElement == 0 && (i.direct = !1), !1 !== i.track && (i.track = !0), "function" != typeof i.inside) throw new Error("Property `inside` must be a function");
                                    if ("function" != typeof i.outside) throw new Error("Property `outside` must be a function");
                                    if (null == i.elem) {
                                        if (!1 === u(i.from)) throw new Error("Property `from` must be a absolute value when no `elem` has been provided");
                                        if (!1 === u(i.to)) throw new Error("Property `to` must be a absolute value when no `elem` has been provided")
                                    } else !0 === f(i.from) && (i.from = p(i.from, i.elem)), !0 === f(i.to) && (i.to = p(i.to, i.elem));
                                    return i.from = h(i.from), i.to = h(i.to), null == i.props && (i.props = {}), Object.keys(i.props).forEach(function(t) {
                                        var e = i.props[t];
                                        if (!1 === u(e.from)) throw new Error("Property `from` of prop must be a absolute value");
                                        if (!1 === u(e.to)) throw new Error("Property `from` of prop must be a absolute value");
                                        if (e.from = h(e.from), e.to = h(e.to), "string" == typeof e.timing && null == r.default[e.timing]) throw new Error("Unknown timing for property `timing` of prop");
                                        null == e.timing && (e.timing = r.default.linear), "string" == typeof e.timing && (e.timing = r.default[e.timing])
                                    }), i
                                }(t)
                            },
                            update: function() {
...
function(t, e) {
    ...
    function b(t) {
        if (function() {
            ...
            }(), "string" == typeof t && (t = document.querySelector(t)), t && "object" == (void 0 === t ? "undefined" : _typeof(t)) && t.nodeType) {
            var e = y(t);
            ...
            var v = g(e.height);
            return !1 !== v && (i.height = v + (p ? 0 : c + f)), i.innerWidth = i.width - (l + h), i.innerHeight = i.height - (c + f), i.outerWidth = i.width + u, i.outerHeight = i.height + d, i
        }
    }
    var L, i = "undefined" == typeof console ? function() {} : function(t) {
            console.error(t)
        },
...
function(e, i) {
    "function" == typeof define && define.amd ? define("flickity/js/cell", ["get-size/get-size"], function(t) {
        return i(e, t)
    }) : "object" == ("undefined" == typeof module ? "undefined" : _typeof(module)) && module.exports ? module.exports = i(e, require("get-size")) : (e.Flickity = e.Flickity || {}, e.Flickity.Cell = i(e, e.getSize))
}(window, function(t, e) {
    function i(t, e) {
...
function(e, i) {
    "function" == typeof define && define.amd ? define("flickity/js/animate", ["fizzy-ui-utils/utils"], function(t) {
        return i(e, t)
    }) : "object" == ("undefined" == typeof module ? "undefined" : _typeof(module)) && module.exports ? module.exports = i(e, require("fizzy-ui-utils")) : (e.Flickity = e.Flickity || {}, e.Flickity.animatePrototype = i(e, e.fizzyUIUtils))
}(window, function(t, s) {
    var e = {
        ...
        positionSlider: function() {
            var t = this.x;
            this.options.wrapAround && 1 < this.cells.length && (t = s.modulo(t, this.slideableWidth), t -= this.slideableWidth, this.shiftWrapCells(t)), t += this.cursorPosition, t = this.options.rightToLeft ? -t : t;
...
function(r, a) {
    ...
    else if ("object" == ("undefined" == typeof module ? "undefined" : _typeof(module)) && module.exports) module.exports = a(r, require("ev-emitter"), require("get-size"), require("fizzy-ui-utils"), require("./cell"), require("./slide"), require("./animate"));
    else {
        var t = r.Flickity;
    ...
    return p.setCellAlign = function() {
        ...
        this.deactivate(), n.removeEventListener("resize", this), this.emitEvent("destroy"), c && this.$element && c.removeData(this.element, "flickity"), delete this.element.flickityGUID, delete f[this.guid]
...
function(n, o) {
    ...
    o._createDrag = function() {
        this.on("activate", this.onActivateDrag), this.on("uiChange", this._uiChangeDrag), this.on("childUIPointerDown", this._childUIPointerDownDrag), this.on("deactivate", this.unbindDrag), this.on("cellChange", this.updateDraggable), s && !r && (i.addEventListener("touchmove", function() {}), r = !0)
...
function(e, i) {
    ...
    function r(t, e, i) {
        ...
        var n, o = t;
        return "string" == typeof t && (o = document.querySelectorAll(t)), o ? (this.elements = (n = o, Array.isArray(n) ? n : "object" == (void 0 === n ? "undefined" : _typeof(n)) && "number" == typeof n.length ? c.call(n) : [n]), this.options = s({}, this.options), "function" == typeof e ? i = e : s(this.options, e), i && this.on("always", i), this.getImages(), a && (this.jqDeferred = new a.Deferred), void setTimeout(this.check.bind(this))) : void l.error("Bad element for imagesLoaded " + (o || t))
    }
...
var Reveal = function() {
    function t() {
        _classCallCheck(this, t), this.initVars(), this.initEvents(), this.onScroll()
    }
    return _createClass(t, [{
        key: "initVars",
        value: function() {
            this.isMobile = document.documentElement.clientWidth < 768, this.isBasicScroll = document.querySelector(".basicScroll") && !this.isMobile, this.isBasicScroll ? this.scrollContainer = document.querySelector(".basicScroll") : this.scrollContainer = window, this.revealCollection = document.querySelectorAll(".reveal"), this.lastScrollY = 0, this.ticking = !1, this.offsetMultipler = .85, this.offsetMultiplerMobile = 1, this.onScrollRef = this.onScroll.bind(this)
        }
    }, {
        key: "initEvents",
        value: function() {
        ...
        key: "onScroll",
        value: function() {
            this.isBasicScroll ? this.lastScrollY = this.scrollContainer.pageYOffset || this.scrollContainer.scrollTop : this.lastScrollY = this.scrollContainer.pageYOffset, this.requestTick(this)
        }
    }, {
        key: "requestTick",
        value: function(t) {
            t.ticking || (requestAnimationFrame(t.update.bind(t)), t.ticking = !0)
        }
    }, {
        key: "update",
        value: function() {
            ...
            for (var i = null, n = [], o = window.innerHeight * e, s = 0; s < this.revealCollection.length; s++) i = this.revealCollection[s], n[s] = i.offsetTop, this.lastScrollY > n[s] - o && i.classList.add("reveal-show");
            this.ticking = !1
        }
    }]), t
}();
...
"function" != typeof Object.assign && (Object.assign = function(t) {
    ...
    e = e || window;
    for (var i = 0; i < (void 0).length; i++) t.call(e, (void 0)[i], i, void 0)
});
...
function initPage() {
    ...
    var c = document.querySelectorAll(".module-gallery .gallery"),
        s = function() {
            ...
            a.hasAttribute("autoplay") && a.play(), o.innerHTML = r.selectedIndex + 1, s.innerHTML = r.slides.length, e.addEventListener("click", function(t) {
...
window.addEventListener("load", function(e) {
    ...
    setTimeout(function() {
        ...
        documentBody.classList.contains(e) || ("default" == colorModeSelection ? documentBody.classList.remove("ultra-mode") : documentBody.classList.remove(colorModeSelection), documentBody.classList.add("easter-egg"), documentBody.classList.add(e)), colorModeSelection = e
        ...
        var e = t.target.getAttribute("class");
        documentBody.classList.contains(e) || (documentBody.classList.remove(colorModeSelection), documentBody.classList.add("easter-egg"), documentBody.classList.add(e)), colorModeSelection = e
        ...
        t.stopPropagation(), t.preventDefault(), isMobile && documentBody.classList.remove("mobileNavOpen"), aboutContainer.scrollTop = 0, documentBody.classList.add("navTop"), documentBody.classList.add("aboutShow")
    }), aboutBack.addEventListener("click", function(t) {
        t.stopPropagation(), t.preventDefault(), (documentBody.classList.contains("home-page") || documentBody.classList.contains("work-page") && ui.classList.contains("bottom") || !documentBody.classList.contains("journal-page") && ui.classList.contains("bottom")) && documentBody.classList.remove("navTop"), documentBody.classList.remove("aboutShow"), isMobile && documentBody.classList.add("mobileNavOpen")
    ...
    var Workpage = Barba.BaseView.extend({
        ...
        onLeave: function() {
            documentBody.classList.contains("first-load") && documentBody.classList.remove("first-load"), stopPage(), documentBody.classList.remove("work-page-js"), !documentBody.classList.contains("easter-egg") && documentBody.classList.contains("night-mode") && (colorModeSelection = "default")
        },
        onLeaveCompleted: function() {
            documentBody.classList.contains("night-mode") && null == documentBody.querySelector(".hero.dark") && "night-mode" != colorModeSelection && documentBody.classList.remove("night-mode"), documentBody.classList.contains("work-page-js") || documentBody.classList.remove("work-page")
        }
    });
    Workpage.init();
    var Journalpage = Barba.BaseView.extend({
        ...
        onEnterCompleted: function() {
            documentBody.classList.add("journal-page-js"), initPage(), setTimeout(function() {
                documentBody.classList.contains("journal-page") || documentBody.classList.add("journal-page")
            }, 500)
        },
        onLeave: function() {
            stopPage(), documentBody.classList.remove("journal-page-js")
        },
        onLeaveCompleted: function() {
    ...
    var JournalPostpage = Barba.BaseView.extend({
        ...
        onEnterCompleted: function() {
            documentBody.classList.add("journal-post-page-js"), initPage(), setTimeout(function() {
                documentBody.classList.contains("journal-post-page") || documentBody.classList.add("journal-post-page"), !documentBody.classList.contains("easter-egg") && document.querySelector(".barba-container.dark") && "default" == colorModeSelection && (colorModeSelection = "night-mode", documentBody.classList.add(colorModeSelection))
            }, 500)
        },
        onLeave: function() {
            stopPage(), documentBody.classList.remove("journal-post-page-js"), !documentBody.classList.contains("easter-egg") && documentBody.classList.contains("night-mode") && (colorModeSelection = "default")
        },
        onLeaveCompleted: function() {
            !documentBody.classList.contains("easter-egg") && documentBody.classList.contains("night-mode") && documentBody.classList.remove("night-mode"), documentBody.classList.remove("journal-post-page")
        }
    });
...
var Home = function() {
        ...
        return _createClass(e, [{
            ...
            value: function() {
                ...
                }, 3e3), this.projectsLi.forEach(function(t) {
...
var JournalPost = function() {
        function e(t) {
            _classCallCheck(this, e), this.initVars(t), this.initEvents(), this.initJournalPost()
        }
        return _createClass(e, [{
            key: "initVars",
            value: function(t) {
                this.documentBody = document.body, this.ui = document.querySelector(".ui"), this.post = document.querySelector(".post"), this.postContainer = document.querySelector(".post .container"), this.postContent = document.querySelector(".post .content"), this.firstRun = !0, this.isMobile = document.documentElement.clientWidth < 768, this.isSafari = !1, /^((?!chrome|android).)*safari/i.test(navigator.userAgent) && !this.isMobile && (this.isSafari = !0, this.documentBody.classList.add("safari")), this.scrollHeight = 0, this.scrollOffset = 0, this.scrollPercent = 0, this.contentPosition = this.scrollPercent, this.resizeRef = this.resize.bind(this), this.scrollRef = this.scroll.bind(this)
            }
        }, {
            key: "initEvents",
            value: function() {
                this.isMobile || (window.addEventListener("resize", this.resizeRef, !1), this.post.addEventListener("scroll", this.scrollRef, !1))
            }
        }, {
            key: "stopEvents",
            value: function() {
                this.isMobile || (window.removeEventListener("resize", this.resizeRef, !1), this.post.removeEventListener("scroll", this.scrollRef, !1))
            }
        }, {
            key: "initJournalPost",
            value: function() {
                this.isMobile || (this.resize(), this.loop()), document.querySelectorAll(".parallax-vertical-mm-bt").forEach(function(t) {
            ...
            key: "resize",
            value: function() {
                this.scrollHeight = this.postContent.offsetHeight, this.postContainer.style.height = this.scrollHeight + "px"
            }
        }, {
            key: "loop",
            value: function() {
                this.contentPosition = this.lerp(this.contentPosition, this.scrollPercent, .05), this.contentPosition = Math.floor(1e4 * this.contentPosition) / 1e4;
                var t = "translate3d( 0, " + this.contentPosition + "px, 0)";
                this.postContent.style.mozTransform = t, this.postContent.style.webkitTransform = t, this.postContent.style.transform = t, this.loopRef = this.loop.bind(this), requestAnimationFrame(this.loopRef)
            }
        }, {
            key: "lerp",
            value: function(t, e, i) {
            ...
            value: function() {
                ...
                document.documentElement.clientWidth;
                this.scrollOffset = this.post.pageYOffset || this.post.scrollTop, this.scrollPercent = this.scrollOffset / (this.scrollHeight - this.documentBody.offsetHeight) || 0, this.isMobile || (.07 < this.scrollPercent && !this.ui.classList.contains("outline") ? this.ui.classList.add("outline") : this.scrollPercent <= .07 && this.ui.classList.contains("outline") ? this.ui.classList.remove("outline") : 1 == this.scrollPercent && this.ui.classList.contains("outline") && this.ui.classList.remove("outline"), 1 != this.scrollPercent || this.ui.classList.contains("bottom") ? 1 != this.scrollPercent && this.ui.classList.contains("bottom") && (this.ui.classList.remove("bottom"), this.documentBody.classList.add("navTop")) : (this.ui.classList.add("bottom"), this.documentBody.classList.remove("navTop"))), this.scrollPercent *= -.075 * this.documentBody.scrollWidth
            }
        }]), e
    }(),
    _createClass = function() {
...
var Journal = function() {
        function e(t) {
            _classCallCheck(this, e), this.initVars(t), this.initEvents(), this.initJournal()
        }
        return _createClass(e, [{
            key: "initVars",
            value: function(t) {
                this.documentBody = document.body, this.ui = document.querySelector(".ui"), this.journal = document.querySelector(".journal"), this.journalContainer = document.querySelector(".journal .container"), this.journalContent = document.querySelector(".journal .content"), this.isMobile = document.documentElement.clientWidth < 768, this.isSafari = !1, /^((?!chrome|android).)*safari/i.test(navigator.userAgent) && !this.isMobile && (this.isSafari = !0, this.documentBody.classList.add("safari")), this.scrollHeight = 0, this.scrollOffset = 0, this.scrollPercent = 0, this.contentPosition = this.scrollPercent, this.resizeRef = this.resize.bind(this), this.scrollRef = this.scroll.bind(this)
            }
        }, {
            key: "initEvents",
            value: function() {
                this.isMobile || (window.addEventListener("resize", this.resizeRef, !1), this.journal.addEventListener("scroll", this.scrollRef, !1))
            }
        }, {
            key: "stopEvents",
            value: function() {
                this.isMobile || (window.removeEventListener("resize", this.resizeRef, !1), this.journal.removeEventListener("scroll", this.scrollRef, !1))
            }
        }, {
            key: "initJournal",
            value: function() {
                this.isMobile || (this.resize(), this.loop()), document.querySelectorAll(".parallax-horizontal-tb-bt").forEach(function(t) {
                    var e = t.getAttribute("data-from"),
                        i = t.getAttribute("data-to"),
                        n = t.getAttribute("data-timing");
                    basicScroll.create({
            ...
            key: "resize",
            value: function() {
                this.scrollHeight = this.journalContent.offsetHeight, this.journalContainer.style.height = this.scrollHeight + "px"
            }
        }, {
            key: "loop",
            value: function() {
                this.contentPosition = this.lerp(this.contentPosition, this.scrollPercent, .05), this.contentPosition = Math.floor(1e4 * this.contentPosition) / 1e4;
                var t = "translate3d( 0, " + this.contentPosition + "px, 0)";
                this.journalContent.style.mozTransform = t, this.journalContent.style.webkitTransform = t, this.journalContent.style.transform = t, this.loopRef = this.loop.bind(this), requestAnimationFrame(this.loopRef)
            }
        }, {
            key: "lerp",
            value: function(t, e, i) {
            ...
            value: function() {
                document.documentElement.clientWidth;
                this.scrollOffset = this.journal.pageYOffset || this.journal.scrollTop, this.scrollPercent = this.scrollOffset / (this.scrollHeight - this.documentBody.offsetHeight) || 0, this.isMobile || (.07 < this.scrollPercent && !this.ui.classList.contains("outline") ? this.ui.classList.add("outline") : this.scrollPercent <= .07 && this.ui.classList.contains("outline") ? this.ui.classList.remove("outline") : 1 == this.scrollPercent && this.ui.classList.contains("outline") && this.ui.classList.remove("outline"), 1 != this.scrollPercent || this.ui.classList.contains("bottom") ? 1 != this.scrollPercent && this.ui.classList.contains("bottom") && this.ui.classList.remove("bottom") : this.ui.classList.add("bottom")), this.scrollPercent *= -.075 * this.documentBody.scrollWidth
            }
        }]), e
    }(),
    _createClass = function() {
...
var Work = function() {
    function e(t) {
        _classCallCheck(this, e), this.initVars(t), this.initEvents(), this.initWork()
    }
    return _createClass(e, [{
        key: "initVars",
        value: function(t) {
            this.documentBody = document.body, this.ui = document.querySelector(".ui"), this.caseStudy = document.querySelector(".case-study"), this.caseStudyContainer = document.querySelector(".case-study .container"), this.caseStudyContent = document.querySelector(".case-study .content"), this.firstRun = !0, this.isMobile = document.documentElement.clientWidth < 768, this.isSafari = !1, /^((?!chrome|android).)*safari/i.test(navigator.userAgent) && !this.isMobile && (this.isSafari = !0, this.documentBody.classList.add("safari")), this.nightMode = null != documentBody.querySelector(".hero.dark"), this.scrollHeight = 0, this.scrollOffset = 0, this.scrollPercent = 0, this.contentPosition = this.scrollPercent, this.resizeRef = this.resize.bind(this), this.scrollRef = this.scroll.bind(this)
        }
    }, {
        key: "initEvents",
        value: function() {
            this.isMobile || (window.addEventListener("resize", this.resizeRef, !1), this.caseStudy.addEventListener("scroll", this.scrollRef, !1))
        }
    }, {
        key: "stopEvents",
        value: function() {
            this.isMobile || (window.removeEventListener("resize", this.resizeRef, !1), this.caseStudy.removeEventListener("scroll", this.scrollRef, !1))
        }
    }, {
        key: "initWork",
        value: function() {
            this.isMobile || (this.resize(), this.loop()), this.nightMode && !documentBody.classList.contains("easter-egg") && setTimeout(function() {
                documentBody.classList.add("night-mode")
            }, 1e3), document.querySelectorAll(".parallax-vertical-mm-bt").forEach(function(t) {
                var e = t.getAttribute("data-from"),
                    i = t.getAttribute("data-to"),
                    n = t.getAttribute("data-timing");
                basicScroll.create({
        ...
        key: "resize",
        value: function() {
            this.scrollHeight = this.caseStudyContent.offsetHeight, this.caseStudyContainer.style.height = this.scrollHeight + "px"
        }
    }, {
        key: "loop",
        value: function() {
            this.contentPosition = this.lerp(this.contentPosition, this.scrollPercent, .05), this.contentPosition = Math.floor(1e4 * this.contentPosition) / 1e4;
            var t = "translate3d( 0, " + this.contentPosition + "px, 0)";
            this.caseStudyContent.style.mozTransform = t, this.caseStudyContent.style.webkitTransform = t, this.caseStudyContent.style.transform = t, this.loopRef = this.loop.bind(this), requestAnimationFrame(this.loopRef)
        }
    }, {
        key: "lerp",
        value: function(t, e, i) {
        ...
        value: function() {
            this.firstRun && (this.firstRun = !1, this.resize());
            document.documentElement.clientWidth;
            this.scrollOffset = this.caseStudy.pageYOffset || this.caseStudy.scrollTop, this.scrollPercent = this.scrollOffset / (this.scrollHeight - this.documentBody.offsetHeight) || 0, this.isMobile || (.07 < this.scrollPercent && this.scrollPercent < 1 && !this.ui.classList.contains("outline") ? this.ui.classList.add("outline") : this.scrollPercent <= .07 && this.ui.classList.contains("outline") ? this.ui.classList.remove("outline") : 1 <= this.scrollPercent && this.ui.classList.contains("outline") && this.ui.classList.remove("outline"), 1 != this.scrollPercent || this.ui.classList.contains("bottom") ? 1 != this.scrollPercent && this.ui.classList.contains("bottom") && (this.ui.classList.remove("bottom"), this.documentBody.classList.add("navTop")) : (this.ui.classList.add("bottom"), this.documentBody.classList.remove("navTop"))), this.scrollPercent *= -.075 * this.documentBody.scrollWidth
        }
    }]), e
}();